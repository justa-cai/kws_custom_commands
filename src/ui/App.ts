...
import { button, el, field, svgIcon } from './dom';
...
/** 源码仓库。页面右上角那个链接指向它，README 和 LICENSE 也用同一个地址 */
const REPO_URL = 'https://github.com/justa-cai/kws_custom_commands';

/** GitHub 官方 mark（octicons，MIT）的 16×16 path */
const GITHUB_MARK =
